...
public final class KLog {
     ...
     * 最低日记输出级别
     */
    public static int PRIORITY = V;

    // 日志最低输出级别
    private static int logPriority = PRIORITY;
    ...
    public static void file(String logFileDir, Object msg) {
        printFile(null, msg, logFileDir);
    }

    public static void file(String logFileDir, String tag, Object msg) {
        printFile(tag, msg, logFileDir);
    }
    ...
    private static void printFile(String tagStr, Object objectMsg, String logFileDir) {
        if (!IS_SHOW_LOG) {
            return;
        }
        ...
        FileLog.printFile(tag, headString, msg, logFileDir);
    }
    ...
    private static String[] wrapperContent(int stackTraceIndex, String tagStr, Object... objects) {
        ...
        if (TextUtils.isEmpty(tag) && !TextUtils.isEmpty(mGlobalTag)) {
            tag = mGlobalTag;
        }
