...
public class ProgressRequestBody<Result> extends RequestBody {
    ...
    private FileUploadObserver<Result> fileUploadObserver;

    public ProgressRequestBody(File file, FileUploadObserver<Result> fileUploadObserver) {
        this.mRequestBody = RequestBody.create(MediaType.parse("application/octet-stream"), file);
        this.fileUploadObserver = fileUploadObserver;
    }

    public ProgressRequestBody(RequestBody requestBody, FileUploadObserver<Result> fileUploadObserver) {
