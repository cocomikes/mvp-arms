...
import io.ganguo.library.mvp.ui.mvp.base.BaseUrl;
...
import io.ganguo.library.mvp.ui.mvp.integration.cache.LruCache;
...
public class GlobalConfigModule {
    ...
    private GlobalConfigModule(Builder builder) {
        ...
        this.mAppDataPath = builder.appDataPath;
    }
    ...
    HttpUrl provideBaseUrl() {
        ...
        return mApiUrl == null ? HttpUrl.parse("https://xxx/") : mApiUrl;
    }
    ...
    File provideCacheFile(Application application) {
        return mCacheFile == null ? new File(Config.getFileCachePath()) : mCacheFile;
    }
    ...
    ExecutorService provideExecutorService() {
        return mExecutorService == null ? new ThreadPoolExecutor(0, Integer.MAX_VALUE, 60, TimeUnit.SECONDS,
                new SynchronousQueue<Runnable>(), Util.threadFactory("CBase Executor", false)) : mExecutorService;
    }
    ...
    @Provides
    @Named("AppDataPath")
    String provideAppDataPath() {
        return mAppDataPath == null ? "MobileApp" : mAppDataPath;
    }
    ...
    public static final class Builder {
        ...
        public Builder appDataPath(String appDataPath) {
