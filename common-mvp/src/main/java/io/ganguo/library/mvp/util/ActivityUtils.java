...
public class ActivityUtils {
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(AppUtils.getTopActivityOrApp(), null, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls,
                                     final Bundle options) {
        startActivity(AppUtils.getTopActivityOrApp(), null, pkg, cls, options);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     @NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(AppUtils.getTopActivityOrApp(), extras, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     ...
                                     @NonNull final String cls,
                                     final Bundle options) {
        startActivity(AppUtils.getTopActivityOrApp(), extras, pkg, cls, options);
    }
    ...
    public static boolean startActivity(@NonNull final Intent intent) {
        return startActivity(intent, AppUtils.getTopActivityOrApp(), null);
    }
    ...
    public static boolean startActivity(@NonNull final Intent intent,
                                        @NonNull final Bundle options) {
        return startActivity(intent, AppUtils.getTopActivityOrApp(), options);
    }
    ...
    public static boolean startActivityWithDefaultAnimation(@NonNull final Intent intent){
        int enterAnim = R.anim.cbase__slide_in_from_right;
        int exitAnim = R.anim.cbase__slide_out_to_left;
     ...
     * @param intent    The description of the activity to start.
     */
    public static void startActivityWithDefaultAnimation(@NonNull final Activity activity,
                                     @NonNull final Intent intent) {
        int enterAnim = R.anim.cbase__slide_in_from_right;
        int exitAnim = R.anim.cbase__slide_out_to_left;
    ...
    public static void startActivityForResultWithDefaultAnimation(@NonNull final Activity activity,
                                              @NonNull final Intent intent,
                                              final int requestCode) {
        int enterAnim = R.anim.cbase__slide_in_from_right;
        int exitAnim = R.anim.cbase__slide_out_to_left;
    ...
    public static void startActivities(@NonNull final Intent[] intents) {
        startActivities(intents, AppUtils.getTopActivityOrApp(), null);
    }
    ...
    public static void startActivities(@NonNull final Intent[] intents,
                                       final Bundle options) {
        startActivities(intents, AppUtils.getTopActivityOrApp(), options);
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(AppUtils.getApp().getPackageName());
    }
    ...
    public static Activity getTopActivity() {
        return AppUtils.getActivityLifecycle().getTopActivity();
    }

    public static String getCurrentActivityName(){
        return getTopActivity().getClass().getSimpleName();
    }
    ...
    public static void finishAllActivities(final boolean isLoadAnim) {
        List<Activity> activityList = AppUtils.getActivityList();
    ...
    public static Drawable getActivityLogo(@NonNull final Class<? extends Activity> clz) {
        return getActivityLogo(new ComponentName(AppUtils.getApp(), clz));
    }
