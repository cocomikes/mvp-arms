...
import io.ganguo.library.mvp.ui.mvp.di.component.DaggerAppComponent;
...
import io.ganguo.library.mvp.ui.mvp.integration.ManifestParser;
import io.ganguo.library.mvp.ui.mvp.integration.cache.IntelligentCache;
...
/**
 * ================================================
 * AppComponentDelegate 可以代理 Application 的生命周期,在对应的生命周期,执行对应的逻辑,因为 Java 只能单继承
 * 所以当遇到某些三方库需要继承于它的 Application 的时候,就只有自定义 Application 并继承于三方库的 Application
 * 这时就不用再继承 BaseContext,只用在自定义Application中对应的生命周期调用AppDelegate对应的方法
 * (Application一定要实现APP接口),框架就能照常运行
 *
 * @see io.ganguo.library.mvp.BaseContext
 * ================================================
 */
public class AppComponentDelegate implements App, AppLifecycles {
    ...
    public AppComponentDelegate(@NonNull Context context) {
    ...
    public void onCreate(@NonNull Application application) {
        ...
        Config.setDataPath(mAppDataPath);
    ...
    /**
     * 将 {@link io.ganguo.library.mvp.ui.mvp.di.component.AppComponent} 返回出去, 供其它地方使用, {@link io.ganguo.library.mvp.ui.mvp.di.component.AppComponent} 接口中声明的方法返回的实例, 在 {@link #getAppComponent()} 拿到对象后都可以直接使用
     *
     * @return App
     ...
     * {@link Application}、{@link Activity}、{@link Service}、{@link ContentProvider}, Fragment, 实现了 {@link ComponentCallbacks2} 接口
    ...
    private static class AppComponentCallbacks implements ComponentCallbacks2 {
         ...
         * {@link ComponentCallbacks2#onTrimMemory(int)} 的回调可以发生在 {@link Application}、{@link Activity}、{@link Service}、{@link ContentProvider}、Fragment
         *
         * @param level 内存级别
