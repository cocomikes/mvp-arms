...
/**
 * Created by mikes on 2018/12/29.
 */
public class KeyboardUtils {
    ...
    public static void showSoftInput(final View view) {
        InputMethodManager imm =
                (InputMethodManager) BaseContext.getInstance().getSystemService(Context.INPUT_METHOD_SERVICE);
        view.setFocusable(true);
        view.setFocusableInTouchMode(true);
        view.requestFocus();
    ...
    public static void hideSoftInput(final Activity activity, EditText editText) {
        InputMethodManager imm =
                (InputMethodManager) activity.getSystemService(Activity.INPUT_METHOD_SERVICE);
    ...
    public static void hideSoftInput(final Context context, EditText editText) {
        InputMethodManager imm =
